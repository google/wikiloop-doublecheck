...
const leaderboard = async (req, res) => {
  ...
  const loggedIn = await getLoggedInLeaderList(startTime, endTime, limit, sortObject);
  const anonymous = await getAnonymousLeaderList(startTime, endTime, limit, sortObject);
  const wikis = await getWikisLeaderList(startTime, endTime, sortObject);
  const totalLoggedIn = await getTotalLoggedInUsers(startTime, endTime, sortObject);
