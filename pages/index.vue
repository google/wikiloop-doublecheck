...
<template>
  ...
  <section>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container">
        <div>
          <a href="https://github.com/google/wikiloop-battlefield" class="github-corner" aria-label="View source on GitHub">
            <svg width="56" height="56" viewBox="0 0 250 250" style="fill:#151513; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
